    ...
    <header className="h-16 flex items-center justify-between px-6 bg-white border-b border-gray-200 shadow-sm flex-shrink-0">
      ...
      <div className="flex items-center gap-3 w-24 justify-end">
        ...
        <Link
          ...
          className="relative p-2 rounded-xl hover:bg-gray-100 transition-colors text-gray-500 hover:text-primary"
          aria-label="알림 센터"
        >
        ...
        <Link
          ...
          className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-gray-100 transition-colors text-gray-500 hover:text-primary"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
